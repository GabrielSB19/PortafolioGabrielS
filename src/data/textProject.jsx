...
const textProject = [
  ...
  },
  {
    ...
    des: "Pagina web que simula un formulario de tarjeta de credito, con animaciones y validaciones",
  ...
  },
  {
    ...
    des: "Pagina web que simula un grafico de gastos, con animaciones y validaciones, lee de un DB local",
  ...
  },
  {
    ...
    des: "Pagina web que simula un gestro de propinas con diferentes opciones de personalización",
    img: TipCalculator,
    section: ["HTML", "CSS", "JavaScript"],
    tag: ["HTML", "JavaScript", "Web", "SCSS"],
  ...
  },
  {
    ...
    section: ["Node JS", "JavaScript", "API Rest"],
    tag: ["Node JS", "JavaScript", "API Rest", "Web"],
  ...
  },
  {
    ...
    des: "Modelo de aprendizaje supervisado utilizando marcos jerarquicos para detectar un cancer benigno o maligno",
    img: IACancer,
    section: ["IA (Python)"],
